<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updatePage.aspx.cs" Inherits="UserDataUpdate.updatePage" %>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Cannot Be Blank" ControlToValidate="TextBox4" Display="Dynamic"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBox4" Display="Dynamic" ErrorMessage="Geçerli Mail Adresi Giriniz" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                        </div>
                        <div class="col-md-12 form-group">
                            <asp:TextBox class="form-control"   ID="TextBox5" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Cannot Be Blank" ControlToValidate="TextBox5" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                       
                        <div class="col-md-12 form-group">
                            <asp:Button class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-2" ID="Button1" runat="server" Text="Update" OnClick="Button1_Click1"  />
                        </div>
                        <div class="col-md-12 form-group">
